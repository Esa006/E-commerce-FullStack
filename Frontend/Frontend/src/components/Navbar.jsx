    ...
    <nav className="navbar navbar-expand-lg bg-white border-bottom sticky-top py-3">
      <div className="container">
        ...
        <ul className="d-none d-md-flex align-items-center gap-4 list-unstyled mb-0">
          <li>
            <NavLink to="/" className={({ isActive }) => `text-decoration-none text-dark small fw-bold text-uppercase ${isActive ? 'border-bottom border-dark border-2' : ''}`}>
              Home
            </NavLink>
          </li>
          <li>
            <NavLink to="/products" end className={({ isActive }) => `text-decoration-none text-dark small fw-bold text-uppercase ${isActive ? 'border-bottom border-dark border-2' : ''}`}>
              Collection
            </NavLink>
          </li>
          <li>
            <NavLink to="/products?category=Men" className={({ isActive }) => `text-decoration-none text-dark small fw-bold text-uppercase ${location.search.includes('category=Men') ? 'border-bottom border-dark border-2' : ''}`}>
              Men
            </NavLink>
          </li>
          <li>
            <NavLink to="/products?category=Women" className={({ isActive }) => `text-decoration-none text-dark small fw-bold text-uppercase ${location.search.includes('category=Women') ? 'border-bottom border-dark border-2' : ''}`}>
              Women
            </NavLink>
          </li>
          <li>
            <NavLink to="/products?category=Kids" className={({ isActive }) => `text-decoration-none text-dark small fw-bold text-uppercase ${location.search.includes('category=Kids') ? 'border-bottom border-dark border-2' : ''}`}>
              Kids
            </NavLink>
          </li>
        </ul>
