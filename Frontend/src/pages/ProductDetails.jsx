      ...
      <div className="row g-5">
        ...
        <div className="col-md-6">
              ...
              {sizes.map((s, index) => {
                ...
                return (
                  <button
                    ...
                    className={`btn size-btn ${size === cleanSize ? "active" : "inactive"
                      }`}
                  >
                    {cleanSize}
                  </button>
          ...
          <div className="my-4">
            ...
            <div className="btn-group border rounded-0 bg-light">
              <button className="btn btn-light px-3 border-end" onClick={handleDecrease}>-</button>
              <span className="btn btn-white disabled px-4 fw-bold quantity-display">{quantity}</span>
              <button className="btn btn-light px-3 border-start" onClick={handleIncrease}>+</button>
            </div>
          </div>
