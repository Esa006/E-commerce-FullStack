		...
		<?php echo $__env->make('crud::inc.grouped_errors', ['id' => $id ?? 'crudForm'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
		  ...
		  <form method="post"
                ...
                <?php if(view()->exists('vendor.backpack.crud.form_content')): ?>
                    <?php echo $__env->make('vendor.backpack.crud.form_content', [ 'fields' => $crud->fields(), 'action' => 'create', 'id' => $id ?? 'crudForm'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('crud::form_content', [ 'fields' => $crud->fields(), 'action' => 'create', 'id' => $id ?? 'crudForm'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
...
<?php echo $__env->make(backpack_view('blank'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\E-commerce-FullStack\13.1.26-backend\vendor\backpack\crud\src\resources\views\crud/create.blade.php ENDPATH**/ ?>