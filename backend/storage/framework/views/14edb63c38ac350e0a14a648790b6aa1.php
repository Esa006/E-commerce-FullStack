<?php if($crud->hasAccess('show', $entry)): ?>
	<?php if(!$crud->model->translationEnabled() || $crud->getOperationSetting('showLanguagesDirectlyInShowButton') === false): ?>
	...
	<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Downloads\E-commerce-FullStack\13.1.26-backend\vendor\backpack\crud\src\resources\views\crud/buttons/show.blade.php ENDPATH**/ ?>